...
public class ControladorVentanaSeleccionarClienteCrearMensaje implements KeyListener, MouseListener
{
	
	private ControladorPanelCorreo controlador;
	private VentanaSeleccionarCliente ventana;
	private List<ClienteDTO> clientes_filtrados;
	
	public ControladorVentanaSeleccionarClienteCrearMensaje(ControladorPanelCorreo control)
	{
