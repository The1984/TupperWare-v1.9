...
public class ControladorVentanaSeleccionarProductoAgregar implements KeyListener, MouseListener
{
	
	private ControladorVentanaAgregarPromocion controlador;
	private VentanaSeleccionarProducto ventana;
	private List<ProductoDTO> productos_filtrados;
	
	public ControladorVentanaSeleccionarProductoAgregar(ControladorVentanaAgregarPromocion control)
	{
